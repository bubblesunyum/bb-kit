---
name: handoff
description: Close out a bb-kit session on purpose — settle the ledger, leave a note for whoever wakes up next, and optionally hand straight off to a fresh agent. Use when work is wrapping up, when the context window is getting long, or when the user says to hand off, wrap up, or take a beat.
---
...
Closed bbk-6sn — the inset really was a no-op, not a sign error.
...
```json
{"date": "2026-08-11", "quote": "the magazine layout is gorgeous", "context": "bbk-abc"}
```
